...
export const BRAND_REGISTRY = {
  ...
  aditya: { name: 'Aditya Birla Health', domain: 'adityabirlahealthinsurance.com', category: 'Insurance', color: '#c4161c' },
  digit: { name: 'Digit Insurance', domain: 'godigit.com', category: 'Insurance', color: '#5b21b6' },
  lic: { name: 'LIC of India', domain: 'licindia.in', category: 'Insurance', color: '#1a3c6b' },
  acko: { name: 'Acko Insurance', domain: 'acko.com', category: 'Insurance', color: '#00c5b7' },
  max: { name: 'Max Life Insurance', domain: 'maxlifeinsurance.com', category: 'Insurance', color: '#d9222a' },
  reliance: { name: 'Reliance General', domain: 'reliancegeneral.co.in', category: 'Insurance', color: '#1e3a8a' },
  kotak: { name: 'Kotak Life Insurance', domain: 'kotaklife.com', category: 'Insurance', color: '#ed1c24' },
  manipalcigna: { name: 'ManipalCigna Health', domain: 'manipalcigna.com', category: 'Insurance', color: '#0a2540' },
  oneassist: { name: 'OneAssist Protection', domain: 'oneassist.in', category: 'Insurance', color: '#dc2626' },
  servify: { name: 'Servify Device Care', domain: 'servify.in', category: 'Insurance', color: '#2563eb' },
